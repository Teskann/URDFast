...
# Constructor ================================================================
    ...
    def convert(self, expression):
        ...
        if expression.replace(' ','') == '(-0.035*sin(theta_CHEST_R_SFE_joint)**2+0.0625*sin(2*theta_CHEST_R_SFE_joint)+0.035)/cos(theta_CHEST_R_SFE_joint)':
            print('stop')
    ...
    def generate_fct(self, fname, params, expr, varss=[], docstr=None,
        ...
        params : list of dict
            Function parameters. Every element of the list has these keys :
                ...
                - description : Parameter description (for doc string)
        ...
        if docstr is not None:
            ...
            if self.docstr_before:
                ...
                real_docstr=self.justify(real_docstr.replace('\n', '\n    '))
                code += real_docstr + '\n\n    '
